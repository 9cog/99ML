...
**1\. Primal System and Primal Categories.**
...
**2\. The Spiral of Self-Organization. (fig.2a.)**
...
Fig. 2a: The main steps recognized in the emergence and successful self-organization of natural systems far from equilibrium are the following:
...
**3\. The Helix of Evolution. (fig.2b.)**
...
fig. 2b. This helical pattern shows the successive emergence of the six cycles of viable systems, in the three planes of existence: objectal (physical) plane of space-time structures, relational (logical) plane of networks of relations and existential (holistic) plane of emerging wholeness.
...
**4\. The six Cycles of the Functioning of Viable Systems. (fig.2c.)**
...
| TRIPLE TROPIC DRIFT | THREE STABILIZING CYCLES | THREE CREATIVE CYCLES |

| --- | --- | --- |

| 1. **Entropic drift** toward uniformity .  2. **Information drift** toward complexity  3\. **Existential drift** toward existence | 1\. **Vortices:** matter recycling, ecological cycles (2)  2. **Self-regulation**: homeostasis (3)  3\. **Existential self-reference**:autonomy (5) | 1. **Self-organization** (1): morphogenesis.  2\. **Self-production** (4): autopoïesis.  3\. **Self-creation** (6): autogenesis. |
...
**3\. The Seven Steps in the Evolution of Viable Self-Organizing Systems.**
...
Other features and some applications of this metamodel can be found in the papers mentioned [above.](https://web.archive.org/web/20041223214322/http://www.unine.ch:80/autogenesis/research.htm)

\*\*\*\*\*\*\*\*

Here is a concise yet comprehensive summary of Eric Schwarz’s *Holistic Metamodel for the Emergence, Evolution and Functioning of Viable Self-Organizing Systems*.

***

### Overview

The holistic metamodel proposed by Schwarz provides a unified, systemic framework to interpret all forms of organization in nature—from physical to biological, social, and cognitive systems. It seeks to articulate the common principles underlying self-organization, evolution, and viability by positing a set of universal categories and developmental cycles.

***

### 1. Primal System and Categories

All natural systems share fundamental invariants and relational laws that transcend their particular material forms.
Three **primal categories** express the essential aspects of any system:

- **Objects:** Elemental units in the physical or energetic plane (matter, organisms).
- **Relations:** Connections forming a logical or informational network (causal, communicational, or cybernetic).
- **Whole:** The existential or holistic plane where integrated identity and consciousness emerge.

A **symbolic elemental system** is conceived as the minimal unit containing these three irreducible aspects—object, relation, and whole—forming a non-separable triad.

***

### 2. The Spiral of Self-Organization

Self-organization describes how new structures arise out of instability in systems far from equilibrium. The process unfolds through seven principal stages:

0. **Entropic drift:** Natural decay or potential instability in the parent system.
1. **Differentiation and fluctuation amplification:** Local positive feedbacks produce morphogenesis (formation of order through fluctuations).
2. **Fluxes and communication:** Exchanges between differentiated substructures.
3. **Network formation:** Emergence of causal, cybernetic relations.
4. **Autopoiesis:** Mutual production of structure and organization (self-production).
5. **Self-reference:** Object and image converge; system becomes reflexive.
6. **Autonomy:** The system operates according to its own internal rules.

This spiral captures the general pattern of emergence: instability, differentiation, organization, and stabilization.

***

### 3. The Helix of Evolution

When the self-organizing spiral repeats across increasingly complex domains, it generates a **helix**—a three-dimensional representation of systemic evolution across three planes:

- **Physical plane:** Space-time structures and energy organization.
- **Relational (logical) plane:** Networks of causal interactions and information.
- **Existential plane:** Holistic self-reference and autonomy.

Each turn of the helix increases structural and informational complexity, enabling the system to evolve from material organization to consciousness.
Three stabilizing cycles and three creative cycles characterize this process:

- **Stabilizing cycles:** Vortices (material), homeostasis (functional), self-reference (existential).
- **Creative cycles:** Morphogenesis (form creation), autopoiesis (self-production), autogenesis (self-creation).

The helix reconciles three evolutionary drifts:

- **Entropic drift** toward uniformity,
- **Informational drift** toward complexity,
- **Existential drift** toward identity.

***

### 4. The Six Cycles of Viable Systems

The metamodel depicts six interrelated cycles operating across the three planes:


| Tropic Drift | Stabilizing Cycles | Creative Cycles |
| :-- | :-- | :-- |
| Entropic drift (uniformity) | Vortices – material recycling | Self-organization – morphogenesis |
| Information drift (complexity) | Homeostasis – regulation | Self-production – autopoiesis |
| Existential drift (identity) | Self-reference – autonomy | Self-creation – autogenesis |

These cycles describe the dynamic interplay between order and change that sustains viability.
Each cycle contributes to the structural and ontological coherence of the system.

***

### 5. The Seven Evolutionary Steps

The global trajectory of self-organizing systems follows seven key phases:

0. **Entropic drift:** From equilibrium decay arises instability.
1. **Morphogenesis:** Formation of differentiated structures.
2. **Vortices:** Cyclical flows establish rhythmic stability.
3. **Homeostasis:** Feedback integration ensures systemic balance.
4. **Autopoiesis:** System produces itself through recursive causality.
5. **Self-reference:** Awareness of its own organization emerges.
6. **Autogenesis:** Creative self-determination and autonomy appear.

These steps move from physical differentiation to existential self-creation, encapsulating the evolution of matter into life, mind, and consciousness.

***

Would you like a visual-style summary (diagrammatic explanation) of how the spiral and helix interact across the three planes?
